...
export default function Toast({ message, type = "info", onClose, duration = 3000 }: ToastProps) {
  ...
  return (
    <div className="fixed top-4 right-4 z-[100] animate-in slide-in-from-top-5 fade-in duration-300">
      <div className={`flex items-center gap-3 px-4 py-3 rounded-xl bg-gradient-to-r ${colors[type]} text-white shadow-2xl backdrop-blur-sm min-w-[300px] max-w-md`}>
        ...
        <button
          onClick={onClose}
          className="flex-shrink-0 rounded-full hover:bg-white/20 p-1 transition-colors"
        >
